git.js
Is a ECMAScript Module Mainly used to apply git flows in a declarativ way it is ported from isomorphic-git which is badly maintained and we plan to later contribute that back if they do not even want to fully deprecate in favor of this module direct.
